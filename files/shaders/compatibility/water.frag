...
#if defined(SHADER_BLENDING) && SHADER_BLENDING && !@waterRefraction
...
#if defined(ENCODE_NORMALS) && ENCODE_NORMALS && @NormalsMode != 2
    vec4 normals = vec4(normalize(gl_NormalMatrix * normal) * 0.5 + 0.5, 1.0);
