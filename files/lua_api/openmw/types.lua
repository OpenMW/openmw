...
---
-- @type ItemData
-- @field #number condition The item's current condition. Time remaining for lights (seetting this to `-1` will make it last forever). Uses left for repairs, lockpicks and probes. Current health for weapons and armor.
