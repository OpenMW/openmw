...
if(NOT OGRE_BUILD_PLATFORM_IPHONE AND APPLE)
  ...
  message( STATUS "OGRE_FRAMEWORK_INCLUDES: " ${OGRE_FRAMEWORK_INCLUDES} )
else()
...
if(APPLE)
    message( STATUS "OGRE_INCLUDE_DIR: " ${OGRE_INCLUDE_DIR} )
endif()
...
macro(ogre_find_component COMPONENT HEADER)
  ...
  if (OGRE_${COMPONENT}_FOUND)
    if (APPLE)
      ...
      message( STATUS "OGRE component found: " ${COMPONENT} )
      message( STATUS "OGRE component include dir: " ${OGRE_${COMPONENT}_INCLUDE_DIR} )
    endif()
    # find binaries
    if (NOT OGRE_STATIC)
      if (WIN32)
