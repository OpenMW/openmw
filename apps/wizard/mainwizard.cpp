    ...
    mGameSettings(mCfgMgr)
{
    ...
    const std::experimental::filesystem::path& installedPath = mCfgMgr.getInstallPath();
...
QString Wizard::MainWizard::toQString(const std::experimental::filesystem::path& path)
{
