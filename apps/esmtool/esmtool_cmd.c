...
const char *gengetopt_args_info_purpose = "Inspect and extract from Morrowind ES files (ESM, ESP, ESS)";

const char *gengetopt_args_info_usage = "Usage: esmtool [OPTIONS]... [ES-FILE]...";
