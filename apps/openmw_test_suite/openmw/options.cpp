...
namespace
{
    ...
    TEST(OpenMWOptionsFromArguments, should_support_multi_component_load_savegame_path)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), "/home/user/openmw/save.omwsave");
    }
    ...
    TEST(OpenMWOptionsFromArguments, should_support_windows_multi_component_load_savegame_path)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), R"(C:\OpenMW\save.omwsave)");
    }
    ...
    /*TEST(OpenMWOptionsFromArguments, should_support_load_savegame_path_with_spaces)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), "my");
...
//        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), "my?ave.omwsave");
    ...
    TEST(OpenMWOptionsFromArguments, should_support_load_savegame_path_with_quote)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), R"(my"save.omwsave)");
    }
...
/*    TEST(OpenMWOptionsFromArguments, should_support_quoted_load_savegame_path)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), R"(save)");
//        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), R"("save".omwsave)");
    }*/
    ...
    TEST(OpenMWOptionsFromArguments, should_compose_data)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_THAT(variables["data"].as<Files::PathContainer>(), ElementsAre(IsPath("1"), IsPath("2")));
    }
    ...
    TEST_P(OpenMWOptionsFromArgumentsStrings, should_support_paths_with_certain_characters_in_load_savegame_path)
    {
        ...
        bpo::variables_map variables;
        parseArgs(arguments, variables, description);
        EXPECT_EQ(variables["load-savegame"].as<boost::filesystem::path>().string(), path);
    }
