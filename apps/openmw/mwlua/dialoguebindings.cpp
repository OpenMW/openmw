...
namespace
{
    ...
    public:
        ...
        {
            return std::count_if(mDialogueStore.begin(), mDialogueStore.end(), [this](const auto& d) { return d.mType == filter; });
        }
    ...
    void prepareBindingsForDialogueRecordStores(sol::table& table, const MWLua::Context& context)
    {
        ...
        sol::usertype<StoreT> storeBindingsClass = lua.new_usertype<StoreT>("ESM3_Dialogue_Type" + std::to_string(filter) + " Store");
    ...
    void prepareBindingsForDialogueRecord(sol::state_view& lua)
    {
        ...
        recordBindingsClass["id"] = sol::readonly_property([lua](const ESM::Dialogue& rec)
        {
            return sol::make_object(lua, rec.mId.serializeText());
        });
        recordBindingsClass["name"] = sol::readonly_property([lua](const ESM::Dialogue& rec)
        {
        ...
        recordBindingsClass["infos"] = sol::readonly_property([lua](const ESM::Dialogue& rec)
        {
    ...
    void prepareBindingsForDialogueRecordInfoList(sol::state_view& lua)
    {
        ...
        recordInfosBindingsClass[sol::meta_function::to_string] = [lua](const DialogueInfos& store) -> sol::object
        {
            ...
            {
                return sol::make_object(lua, "{" + std::to_string(dialogueRecord->mInfo.size()) + " ESM3_Dialogue[" + dialogueRecord->mId.toDebugString() + "] info elements}");
            }
            return sol::nil;
        };
        ...
        recordInfosBindingsClass[sol::meta_function::index] = [](const DialogueInfos& store, size_t index) -> const ESM::DialInfo*
        {
            const ESM::Dialogue* dialogueRecord = store.getDialogueRecord();
    ...
    void prepareBindingsForDialogueRecordInfoListElement(sol::state_view& lua)
    {
        ...
        recordInfoBindingsClass["id"] = sol::readonly_property([lua](const ESM::DialInfo& rec)
        {
            return sol::make_object(lua, rec.mId.serializeText());
        });
        recordInfoBindingsClass["text"] = sol::readonly_property([lua](const ESM::DialInfo& rec)
        {
        ...
        recordInfoBindingsClass["questFinished"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType != ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["questRestart"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType != ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorId"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorRace"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorClass"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorFaction"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorFactionRank"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorCell"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorDisposition"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterActorGender"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterPlayerFaction"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["filterPlayerFactionRank"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            if (rec.mData.mType == ESM::Dialogue::Type::Journal)
            {
                return sol::nil;
        ...
        recordInfoBindingsClass["sound"] = sol::readonly_property([lua](const ESM::DialInfo& rec) -> sol::object
        {
            ...
            return sol::make_object(lua, Misc::ResourceHelpers::correctSoundPath(VFS::Path::Normalized(rec.mSound)).value());
        });
        // // mResultScript TODO
        // // mSelects TODO
    }
