                         ...
                         const QString &name, const QString &defaultValue)
{
    ...
    case Type_MultiRange:
        isMultiValue = true;
    case Type_SingleRange:
        viewType = CSVSettings::ViewType_Range;
    break;

    case Type_MultiText:
        isMultiValue = true;
    case Type_SingleText:
    ...
    item->setProperty(Setting_ViewType, viewType);
    item->setProperty(Setting_IsMultiValue, isMultiValue);
