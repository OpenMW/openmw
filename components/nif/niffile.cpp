...
static std::map<std::string,RecordFactoryEntry> makeFactory()
{
    ...
    newFactory.insert(makeEntry("NiPointLight",               &construct <NiPointLight>                , RC_NiPointLight                  ));
    newFactory.insert(makeEntry("NiSpotLight",                &construct <NiSpotLight>                 , RC_NiSpotLight                   ));
