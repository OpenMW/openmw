...
osg::ref_ptr<Resource::BulletShape> BulletNifLoaderImpl::load(const Nif::File& nif)
{
...
bool BulletNifLoaderImpl::findBoundingBox(const Nif::Node* node)
{
    if (node->hasBounds)
    {
...
bool BulletNifLoaderImpl::hasAutoGeneratedCollision(const Nif::Node* rootNode)
{
...
void BulletNifLoaderImpl::handleNode(const std::string& fileName, const Nif::Node *node, int flags,
...
void BulletNifLoaderImpl::handleNiTriShape(const Nif::Node *nifNode, int flags, const osg::Matrixf &transform,
...
osg::ref_ptr<Resource::BulletShape> BulletNifLoader::load(const Nif::File& file) {
    BulletNifLoaderImpl loader;
